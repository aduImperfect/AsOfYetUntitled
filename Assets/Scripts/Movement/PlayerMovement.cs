...
public class PlayerMovement : MonoBehaviour
{
    ...
    public void GetPath()
    {
        PathfindingHandler.CalculatePath(startingPos, destinationPos, PathfindingAlgorithmType.ASTAR, PathfindingSearchSpace.SQUARE, HeuristicType.EUCLIDEAN_DISTANCE);
